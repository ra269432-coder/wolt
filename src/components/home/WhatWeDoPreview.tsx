        ...
        >
          {pillars.map((pillar, index) => (
            <motion.div
              ...
              className="h-full"
            >
              <div className={`h-full bg-white rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-all duration-500 border border-slate-200 hover:border-blue-200 flex flex-col group relative overflow-hidden`}>
                ...
                <h3 className={`text-2xl font-bold text-slate-900 mb-4 transition-colors ${pillar.hoverText}`}>
                  {pillar.title}
                </h3>
                ...
                <div className="mt-auto pt-6 border-t border-slate-100">
                  <Link href={pillar.link} className={`inline-flex items-center font-bold text-sm tracking-wide text-slate-800 ${pillar.hoverText} transition-colors uppercase`}>
